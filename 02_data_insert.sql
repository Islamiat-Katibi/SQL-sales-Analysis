...
UPDATE EMPLOYEES
SET COMMISSION = 0
WHERE EMPLOYEE_ID IN (2, 5, 8);

UPDATE EMPLOYEES
SET REPORTS_TO = 5
WHERE EMPLOYEE_ID IN (3, 4, 7);
SELECT * FROM EMPLOYEES
...
UPDATE ORDERS
SET SHIP_DATE = '1998-04-26'
WHERE ORDER_NUMBER = 11039;

UPDATE ORDERS
SET SHIP_DATE = '1998-05-04'
WHERE ORDER_NUMBER = 11059;

UPDATE ORDERS
SET SHIP_DATE = '1998-05-10'
WHERE ORDER_NUMBER = 11070;
SELECT * FROM ORDERS
...
-- Inserting Values into Table: ORDER_DETAILS
